...
module.exports = class AssetPipeClient {
    ...
    publish(options = { js: null, css: null }) {
        ...
        return Promise.all(this.publishPromises).then(() => this.hashes);
    }
    ...
    assetUrlByType(hashes = [], type) {
        ...
        // fallback to unbundled files anytime success condition is not met.
